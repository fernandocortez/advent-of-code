...
-- split the multi-line string where each line is a table entry, and whitespace removed
local calibration_document_table = {}
for line in string.gmatch(calibration_document, "[^\n]+") do
    local trimmed = string.gsub(line, "%s+", "")
    table.insert(calibration_document_table, trimmed)
end

local sum = 0
for i = 1, #calibration_document_table do
    local line = calibration_document_table[i]
    local digits = {}
